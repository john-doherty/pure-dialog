...
describe('pure-dialog rendering', function () {
    ...
    it('should set translate=no on container if translate property is false', function() {
        ...
        expect(el.querySelector('.pure-dialog-container').getAttribute('translate')).toBe('no');
    });
